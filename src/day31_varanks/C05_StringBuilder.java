...
public class C05_StringBuilder {
	...
	3) Ayni anda bir cok isin yapilmasina “multi threading” denir. “multi” = Cok, “thread”= Yapilan islerin herbiri
		...
		// Stringlerde method kullanarak String'i degistirmek atama yapmadan mümkün degildir
		// Bunun iki sebebi vardrý
	    //	1.  Java pass-by-value kullanýr. 2. String class'ý immutable class'dýr.
