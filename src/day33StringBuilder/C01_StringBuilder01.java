...
public class C01_StringBuilder01 {
    ...
    //SB de eguals metodu string classýndan farkli calisir.String clsassindaki == operatoru ile ayni 
    //islemi yapar.. HEm icerik hemde referans aesitligine bakar.
    
    String s="hayat";
    StringBuilder sb =new StringBuilder("hayat");
    
    //System.out.println(s==sb);// --> farkli data type larý karsýlastima operotoru derlemeyez CTE verir.
    
    System.out.println(s.equals(sb));//false
    
//SB toString methodu ile stringe cevirelerek string manipulation methodalri kullanilabilir .
    
    System.out.println(s.equals(sb.toString()));//true--> string-string karsilastirmasý equals metodu normal calistir. sadece icerige bakar
    System.out.println(sb.equals(sb.toString()));//false-->sb-string karsilastirmasý equals metodu normal degil == gibi calisir. sadece icerige degil icerik ve ref bakar
